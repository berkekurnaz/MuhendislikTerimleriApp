...
class SuggestionSend extends StatefulWidget {
  @override
  _SuggestionSendState createState() => _SuggestionSendState();
}

class _SuggestionSendState extends State<SuggestionSend> {
